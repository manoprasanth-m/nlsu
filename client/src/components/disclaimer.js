...
><h3 className="modal__title">⚠️Disclaimer⚠️</h3>
 ...
 <ul className="lists">
  ...
  <li className="listitem">You are entering at your own will and we aren't not responsible for Anything as this is an open platform. So kindly be responsible🤟</li>
